...
class DefaultViewExtension extends EModel.Part<ViewExtensionDescription> {
	...
	protected override initContent(ViewExtensionDescription it) {
		name = "Default"
		metamodels += EcorePackage.eINSTANCE
		metamodels += GenModelPackage.eINSTANCE
		categories += Category.create [
			name = "category:EcoretoolsViewExtension.default"
			pages += PageDescription.create [
				name = "ecore_page"
				labelExpression = "Ecore"
				semanticCandidateExpression = "var:self"
				groups += GroupDescription.ref("DefaultViewExtension") [ (it as ViewExtensionDescription).categories.head.groups.get(0) ]
				groups += GroupDescription.ref("DefaultViewExtension") [ (it as ViewExtensionDescription).categories.head.groups.get(5) ]
			...
			pages += PageDescription.create [
				...
				semanticCandidateExpression = "var:self"
				indented = true
				groups += GroupDescription.ref("DefaultViewExtension") [ (it as ViewExtensionDescription).categories.head.groups.get(9) ]
				validationSet = PageValidationSetDescription.create [
					semanticValidationRules += SemanticValidationRule.create [
						name = "NoNameOrInvalid"
						level = ERROR_LEVEL.ERROR_LITERAL
			...
			pages += PageDescription.create [
				...
				semanticCandidateExpression = "var:self"
				indented = true
				groups += GroupDescription.ref("DefaultViewExtension") [ (it as ViewExtensionDescription).categories.head.groups.get(2) ]
			]
			pages += PageDescription.create [
				...
				semanticCandidateExpression = "var:self"
				indented = true
				groups += GroupDescription.ref("DefaultViewExtension") [ (it as ViewExtensionDescription).categories.head.groups.get(10) ]
			...
			pages += PageDescription.create [
				...
				groups += GroupDescription.ref("DefaultViewExtension") [ (it as ViewExtensionDescription).categories.head.groups.get(4) ]
				groups += GroupDescription.ref("DefaultViewExtension") [ (it as ViewExtensionDescription).categories.head.groups.get(1) ]
				groups += GroupDescription.ref("DefaultViewExtension") [ (it as ViewExtensionDescription).categories.head.groups.get(3) ]
				groups += GroupDescription.ref("DefaultViewExtension") [ (it as ViewExtensionDescription).categories.head.groups.get(6) ]
				actions += ToolbarAction.create [
			...
			pages += PageDescription.create [
				...
				groups += GroupDescription.ref("DefaultViewExtension") [ (it as ViewExtensionDescription).categories.head.groups.get(7) ]
				groups += GroupDescription.ref("DefaultViewExtension") [ (it as ViewExtensionDescription).categories.head.groups.get(8) ]
			]
			...
			groups += GroupDescription.create [
				...
				preconditionExpression = ""
				extends = GroupDescription.ref("DefaultViewExtension") [ (it as ViewExtensionDescription).categories.head.groups.get(0) ]
				style = GroupStyle.create [
					expandedByDefault = true
				]
			]
